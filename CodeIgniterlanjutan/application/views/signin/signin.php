<html>
	<head>
		...
		<style>
			body{
				background-image: url("./Asset/gambar/signin.jpg");
							...
							<div class="col-12 align-self-center ">
								...
								<div class="row">
									<div class="form-group col-md-12">
										...
										<input class="form-control" type="password" name="konfirmasi" placeholder="confirmation your password">										
									</div>
								</div>
								...
								<div class="row">
									<button class="btn btn-primary ml-sm-3 mr-sm-2" type="submit">Daftar</button>
